...
public class CircularByteBuffer {
    ...
    protected class CircularByteBufferOutputStream extends OutputStream {
         ...
         * @throws RuntimeException if buffer does not allow blocking writes
        ...
        @Override public void write(byte[] cbuf, int off, int len) throws IOException {
            while (len > 0){
                synchronized (CircularByteBuffer.this){
                    ...
                    if (!blockingWrite && spaceLeft < len) throw new RuntimeException("CircularByteBuffer is full; cannot write " + len + " bytes");
        ...
        @Override public void write(int c) throws IOException {
            ...
            while (!written){
                synchronized (CircularByteBuffer.this){
                    ...
                    if (!blockingWrite && spaceLeft < 1) throw new RuntimeException("CircularByteBuffer is full; cannot write 1 byte");
                    if (spaceLeft > 0){
